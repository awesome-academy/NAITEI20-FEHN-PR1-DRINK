        ...
        <div className="relative container flex flex-col items-center justify-center text-center md:px-64">
          ...
          <div className="absolute top-50 z-0 flex items-center justify-center md:-bottom-1/2">
            <div className="bg-white px-10 py-5 md:p-20">
              <div className="relative flex flex-col items-center justify-center md:h-[400px] md:w-[600px] md:flex-row">
                <div className="relative flex h-full w-full items-center justify-center overflow-hidden md:h-full">
                  <img
                    src={product1}
                    alt="Product 1"
